<template>
  <el-main>
    ...
    <el-form :inline="true" size="mini">
      <el-form-item>
        <el-button type="primary" v-permission="['sys:menu:add']" @click="addBtn" :icon="Plus">新增</el-button>
      </el-form-item>
    </el-form>
    ...
    <el-table :height="tableHeight" :data="menuTable.list" style="width: 100%" row-key="id" border default-expand-all :tree-props="{ children: 'children', hasChildren: 'hasChildren' }">
      ...
      <el-table-column label="操作" align="center" width="200">
        <template #default="scope">
          <el-button v-permission="['sys:menu:edit']" type="primary" size="mini" @click="editBtn(scope.row)" :icon="Edit">编辑</el-button>
          <el-button v-permission="['sys:menu:delete']" type="danger" size="mini" @click="deleteBtn(scope.row.id)" :icon="Delete">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
  </el-main>
